...
#define DATA0 3               // To Encoder Data 0 - Interrupt Pin
#define DATA1 2               // To Encoder Data 1 - Interrupt Pin
...
#define SATURATION 255        // RGB LED Saturation Level
#define FRAMES_PER_SECOND 120 // LED Animation FPS
